...
## Sumário
- [Análise Exploratória](#1-análise-exploratória)
    - [Gráficos de séries temporais](#11-gráficos-de-séries-temporais)
    - [Histrogramas](#12-histogramas)
    - [Boxplots](#13-emboxplotsem)
    - [Distribuição da target](#14-distribuição-da-emtargetem)
    - [Correlação das variáveis de entrada com a target](#15-correlação-das-variáveis-de-entrada-com-a-emtargetem)
- [Pré processamento dos dados (Data Preparation)](#2-pré-processamento-dos-dados-emdata-preparationem)
    - [Limpeza](#21-limpeza)
    - [Feature Engineering](#22-emfeature-engineeringem)
- [Split dos dados](#3-emsplitem-dos-dados)
- [Modelagem](#4-modelagem)
- [Avaliação da performance do modelo](#5-avaliação-da-emperformanceem-do-modelo)
    - [Análise métrica](#51-análise-métrica)
    - [Matriz de confusão](#52-matriz-de-confusão)
    - [Variáveis mais imporantes](#53-variáveis-mais-importantes)
- [Entrega do modelo](#6-entrega-do-modelo)
- [Formas de executar a solução](#7-formas-de-executar-a-solução)
